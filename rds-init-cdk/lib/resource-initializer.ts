...
export interface ResourceInitializerCdkStackProps {
  vpc: ec2.IVpc
...
export class ResourceInitializerCdkStack extends Construct {
  public readonly response: string
  public readonly customResource: AwsCustomResource
  public readonly function: lambda.Function

  constructor (scope: Construct, id: string, props: ResourceInitializerCdkStackProps) {
    super(scope, id);
